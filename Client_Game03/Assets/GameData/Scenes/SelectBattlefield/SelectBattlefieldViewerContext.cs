...

{
    ...
    public class SelectBattlefieldViewerContext

    {
        ...
        public int PageCurrent => SelectBattlefieldSceneInitializator.PanelPrepareBattleInstance.PanelCollection__prefab.PageCurrent;



        public int PageMax => SelectBattlefieldSceneInitializator.PanelPrepareBattleInstance.PanelCollection__prefab.PageMax;
        ...
        public void OnCollectionLoaded(PanelCollection__prefab__scriptMB panelCollection)

        {

            panelCollection.PanelTopButtons_UpdatePageMax();

            panelCollection.PanelTopButtons_SetPageDiapason();
...

        {
            ...
            PanelCollection__prefab__scriptMB panelCollection =
                ...
                SelectBattlefieldSceneInitializator.PanelPrepareBattleInstance.PanelCollection__prefab;

            float width = panelCollection.Width;

            float height = panelCollection.Height - panelCollection.PanelTopButtons_Height;
